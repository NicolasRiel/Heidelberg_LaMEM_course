###############################
# 05_folds NR.02-24
# simple setup to simulate folding using several isoviscous layers and free surface
...
model = Model(   
                ...
                Grid(               x               = [-50.0,50.0],
                                    ...
                                    nel             = (256,1,48) ),             # notice that only one element is given in the y-direction to effectively have a 2D simulation
                ...
                Time(               time_end        = 10.0,                     # Time is always expressed in Myrs (input/output definition)
                                    ...
                                    nstep_max       = 150,                      # Number of wanted timesteps
